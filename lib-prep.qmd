...
8.  This is a test commit

9.  Figure out where you want to put your controls, water, and samples. It helps to have the controls in order of decreasing concentration. A sample layout is shown below.
...
10. Carefully load $4.5 \mu L$ of your samples, water, and controls.
    ...
    ::: callout-tip When adding the master-mix and samples it can be helpful to add it to the side of the well :::
