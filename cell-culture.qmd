...
5. [Count the number of cells](#count-cells) and transfer the amount of medium containing $10^5$ cells into a Sample Lysis Tube (included in kit)
...
9. Centrifuge at $13,000 \times g$ for $5\ minutes$ at $4^\circ C$.
10. Transfer supernatant to a regular 1.5mL microfuge tube (not the ones included in the kit).
11. Start PCR or store for up to 6 months at $-80^\circ C$
