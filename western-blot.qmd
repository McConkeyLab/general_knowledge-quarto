...
1. Add enough Ponceau to cover the membrane and rock for $5\ minutes$

2. Observe staining patterns, checking for even protein amount in each lane

3. Cut the excess membrane off with a razor.

4. Pour Ponceau into a 50mL conical tube wrapped in foil. Store at $room\ temperature$. This can be reused near indefinitely.
...
6. Pour in enough TBS-T to comfortably cover the blot. Rock at $60rpm$ for $5\ minutes$. Repeat for a total of three washes.
  * Covering with TBS-T and rocking for 5min will henceforth be called a 'wash'
...
1. Incubate membrane with $1^\circ$ antibody in $10mL$ casein for $2\ hours$
  * Generally you should dilute the antibody 1:1000
  * If using anti-actin, incubate for only $1\ hour$ and dilute 1:2000
2. Wash 3x


### Secondary Antibody

1. Incubate membrane with $2^\circ$ antibody in $10mL$ casein for $1\ hour$
  * Generally you should dilute the antibody 1:5000
  * Generally you will use Goat-Anti-Rabbit, but this depends entirely on your primary antibody
2. Wash 3x
...
:::{.callout-note}
Turn on ChemiDoc by flicking the switch on the black left of the machine. The power light on front should be green.
