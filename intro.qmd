...
## Overview
This book serves as a community contributed repository of protocols for the McConkey lab.
...
This book is a collation of protocols created and tweaked by a collection of talented individuals. Among those include Megan Fong, Bridget McGuire, Jack Mountain, Dr. Bryan Wehrenberg, Dr. Elina Valchou, and Gabriela Colocho.
...
The TRIzol extraction protocol was written and  sent in by Dr. Elina Vlachou.

The histone extraction protocol was written and sent in by Gabriela Colocho.
...
If you would like to make a contribution but submitting via GitHub pull is complex enough to prevent your from contributing, feel free to submit protocols written in your favorite text editor to me (Kai) via email. Don't worry too much about formatting as it will likely be significantly changed during the transcription process. 
